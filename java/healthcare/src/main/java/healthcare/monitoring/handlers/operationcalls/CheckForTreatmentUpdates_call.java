...
/**
 * This is the CallOperationAction handler for checkForTreatmentUpdates_call.
 * 
 * @generated
 */
@Prototype
public class CheckForTreatmentUpdates_call implements CallOperationActionHandler<Void, Void> {

	private static final Logger LOG = LoggerFactory.getLogger(CheckForTreatmentUpdates_call.class);
	...
	public void handleResult(Void result) {
		LOG.info("checkForTreatmentUpdates() successful");
