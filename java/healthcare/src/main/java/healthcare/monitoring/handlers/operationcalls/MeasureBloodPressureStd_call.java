...
/**
 * This is the CallOperationAction handler for measureBloodPressureStd_call.
 * 
 * @generated
 */
@Prototype
public class MeasureBloodPressureStd_call implements CallOperationActionHandler<Void, BloodPressure> {

	private static final Logger LOG = LoggerFactory.getLogger(MeasureBloodPressureStd_call.class);
	...
	public void handleResult(BloodPressure result) {
		LOG.info("measureBloodPressure() = {}/{}", result.getMmHgSystolic(), result.getMmHgDiastolic());
